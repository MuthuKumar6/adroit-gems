...
//         // Recurse in case it was double-stringified
//         return toArray(parsed);
//       } catch {
//         // fall through
//       }
//     }
//     // Strip stray quotes and split by comma
//     return trimmed
//       .replace(/^["']+|["']+$/g, '')
//       .split(',')
...
//       taxable: pt.taxable ?? true,
//       huids: toArray(pt.huids)
//         .map(h => h.replace(/^["']+|["']+$/g, '').trim())
//         .filter(Boolean)
//         .join(', '),
//       grossWeight: String(pt.gross_weight || ''),
//       netWeight: String(pt.net_weight || ''),
//       stoneWeight: String(pt.stone_weight || 0),
//       wastagePercentage: String(pt.wastage_percentage || ''),
//       makingCharges: String(pt.making_charges || ''),
//       makingChargeType: pt.making_charge_type || 'per_gram',
//       description: pt.description || '',
//       quantity: String(pt.quantity || ''),
//       inStock: String(pt.in_stock || ''),
//     });
//     setDialogOpen(true);
//   };
...
//       id: form.productId,
//       name: form.name.trim(),
//       tagNo: form.tagNo.trim().toUpperCase(),
//       hasSubName: form.hasSubName,
...
//                                 {pt.subNames.slice(0, 2).join(', ')}
//                                 {pt.subNames.length > 2 && ` +${pt.subNames.length - 2}`}
//                               </p>
//                             )} */}
//                             {pt.hasSubName && toArray(pt.sub_names).length > 0 && (
//                               <p className="text-[10px] text-muted-foreground mt-0.5">
...
//                             )}
//                           </TableCell>
//                           <TableCell><Badge variant="secondary">{pt.tag_no || '—'}</Badge></TableCell>
//                           <TableCell>
//                             <Badge variant={pt.taxable ? 'default' : 'outline'}>
//                               {pt.taxable ? 'Taxable' : 'Non-Tax'}
//                             </Badge>
//                           </TableCell>
//                           <TableCell>
...
//                               {/* {pt.huids?.slice(0, 3).map(h => (
//                                 <Badge key={h} variant="secondary" className="text-[10px]">{h}</Badge>
//                               ))}
//                               {pt.huids?.length > 3 && (
//                                 <Badge variant="secondary" className="text-[10px]">+{pt.huids.length - 3}</Badge>
//                               )} */}
//                               {toArray(pt.huids).slice(0, 3).map(h => (
//                                 <Badge key={h} variant="secondary" className="text-[10px]">{h}</Badge>
//                               ))}
//                               {toArray(pt.huids).length > 3 && (
//                                 <Badge variant="secondary" className="text-[10px]">+{toArray(pt.huids).length - 3}</Badge>
//                               )}
//                             </div>
//                           </TableCell>
...
//                           </TableCell>
//                           <TableCell>
//                             <Badge variant={pt.in_stock <= 0 ? 'destructive' : pt.in_stock <= 3 ? 'outline' : 'default'}>
...
//                   <Input
//                     value={form.tagNo}
//                     onChange={e => setForm(f => ({ ...f, tagNo: e.target.value.toUpperCase() }))}
//                     placeholder="CH"
//                   />
//                 </div>
//                 <div className="grid gap-2">
...
//                     onChange={e => setForm(f => ({ ...f, stoneWeight: e.target.value }))}
//                   />
//                 </div>
//               </div>
...
//                     onChange={e => setForm(f => ({ ...f, wastagePercentage: e.target.value }))}
//                   />
//                 </div>
//                 <div className="grid gap-2">
...
//                     onValueChange={(v) => setForm(f => ({ ...f, makingChargeType: v as 'per_gram' | 'flat' }))}
//                   >
//                     <SelectTrigger><SelectValue /></SelectTrigger>
//                     <SelectContent>
